...
public class GoogleBooksController implements MyLoggable{
    ...
    public ModelAndView getBooks(@RequestParam(value = "author",required = false) String author,
        ...
        books.add(new Book(null,"Преступление и наказание", "Достоевский", "комментарий раз",false, null));
        books.add(new Book(null,"ПОЧЕМУ Я МУДАК", "Ильюшка", "комментарий два",false, null));
