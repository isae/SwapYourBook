...
import ru.ifmo.ctddev.swapyourbook.mybatis.gen.model.UserExample.Criteria;
import ru.ifmo.ctddev.swapyourbook.mybatis.gen.model.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getAvatarid() != null) {
            VALUES("avatarID", "#{avatarid,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getAvatarid() != null) {
            SET("avatarID = #{avatarid,jdbcType=INTEGER}");
        }
